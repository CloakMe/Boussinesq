...
\small
		\resizebox{\textwidth}{!}{\begin{tabular}{||c|l|ll|ll|l||}
			\hline
			\hline
      \multirow{2  }{*}{FDS}        & \multirow{2  }{*}{$h$, $\tau$}  & \multirow{2  }{*}{$\Vert u_{h} - (u_{ex})_{h} \Vert_{L_2}$}  &Conv.& \multirow{2  }{*}{$\Vert u_{h} - (u_{ex})_{h} \Vert_\infty$}  &Conv. & \multirow{2  }{*}{ $max|E(y^{0}) - E(y^k)|$}  \\
	                                        &                                                     &                                                                 &  Rate &                                                                       & Rate &  \\
   			\hline 
					\hline 
