...
\small
		\begin{tabular}{|c|l|l|l|l|l|l|}
			\hline
Method                    & $(h, \tau)$   &    $|u_{ex}-u_{h}|_{L2}$  &    $|u_{ex}-u_{h}|_{\infty}$  &   $|E_{h}-E_1|_{\infty}$ &   $|M_{h}-M_1|_{\infty}$       \\
			\hline
           ...
           Taylor, $p=4$       & $(0.4,0.001)$  &  $0.000629$     &      $0.000385$               &            ---           &               $1.1196e-05$     \\
			\hline
  		\end{tabular}
	\caption{Error norms of the solution, energy (in case of Conservative FDS) and mass.}
	\label{final35}
\end{table}
