...
\end{center}
The Mass (left) and Energy (right) of the solution for $T = 10$ and $\beta=3$, $c = 0.45$ (top) and $\beta=1$, $c = 0.9$ (bottom).
\end{frame}
...
It is obtained that:
\begin{description}
 \item[$\beta = 3$, $c = 0.52$] $||u_h(t=40)-u_h(t=0)|_{L_2} = 0.023453$ and $||u_h(t=40)-u_h(t=0)||_{L_{\infty}} = 0.026302$
 \item[$\beta = 1$, $c = 0.9$] $||u_h(t=40)-u_h(t=0)|_{L_2} = 0.000812$ and $||u_h(t=40)-u_h(t=0)||_{L_{\infty}} = 0.000039$
\end{description}
\end{frame}
