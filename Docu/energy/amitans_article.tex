...
and evaluated in \cite{ref13}, \cite{ref14}, \cite{ref15} and \cite{ref16}. 
The stationary problem is an elliptic partial differential equation and its solution is used as initial condition for \rf{problem}. Therefore it is an important aspect of the present work.
