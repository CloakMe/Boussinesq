...
%\baselineskip=0.95\normalbaselineskip
\kwams{}
{two dimensional Boussinesq equation, traveling wave solutions (TWS), high order finite difference schemes, asymptotic boundary conditions}
\def\thefootnote{*}
...
%The  TWS to \rf{eq1} in the two dimensional case  were  computed in \cite{chd-chr, chr-chr-07,chr-chr,Ch2012,Ch2011}. 
...
International Journal of Applied Mathematics, Vol. 32, No 1 (2019)
