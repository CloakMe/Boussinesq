...
\bibitem{ref2} J. Boussinesq, %J. (1871). “%
...
\bibitem{ref14} N. Kolkovska, Two Families of Finite Difference Schemes for Multidimensional Boussinesq Paradigm Equation, 
{\it Applications of Mathematics in Technical and Natural Sciences},
AIP Conference Proceedings, Sozopol (Bulgaria), \textbf{1301} (2010), 395.

\bibitem{ref15} N. Kolkovska, K. Angelow, Numerical Computation of the Critical Energy Constant for Two-dimensional Boussinesq Equations,  
...
\bibitem{ref16} P.Northrop, P.A.Ramachandran, W.Schiesser, V. R.Subramanian, A robust false transient method of lines for elliptic partial differential equations, 
