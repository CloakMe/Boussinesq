...
\begin{figure}[ht]\vspace{0.2cm}
	...
	\end{minipage}
\caption{Масата от решението на Тейлор при $O(|h|^6 + \tau^6)$ апроксимация и време $T=10$ върху три различни по големина области. Левия панел е за $\beta =  3$, $c = 0.45$, а десния панел е за $\beta =  1$, $c = 0.9$.}
\label{Test1_2Mass}
\end{figure}
