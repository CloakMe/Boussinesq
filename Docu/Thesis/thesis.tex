...
$$\bar E_i =  \Vert u_{h,\tau} - u_{(h/2,\tau/2)} \Vert_\kappa.$$ 
При Енергията съответно в Таблици \rf{tableD} и \rf{tableB} се използва следния запис
$$\bar{\bar{ E_i}} =  \Vert E(u_{h,\tau}) - E(u_{(h/2,\tau/2)}) \Vert_\kappa.$$ 
...
\small
		\begin{tabular}{||c|l|ll|ll||}
			\hline
			\hline
      \multirow{2  }{*}{FDS}        & \multirow{2  }{*}{$h$, $\tau$}  &    $L_2$ норма 	&Ред на & $L_\infty$ норма          &Ред на   \\
	                                        &                                                     & $\bar E_i$    	&  сход. & $\bar E_i$ 		  & сход. \\
   			\hline 
					\hline 
  $\beta=3$                &0.2, 0.001         &                    &                &                  &                   \\
...
\small
		\begin{tabular}{||c|l|ll|ll||}
			...
			\hline
      \multirow{2  }{*}{FDS}        & \multirow{2  }{*}{$h$, $\tau$}  &  $L_2$ норма      			&Ред на	& $L_\infty$ норма        &Ред на   \\
	                                        &                                                     & $\bar{\bar{ E_i}}$  		&  сход. 	& $\bar{\bar{ E_i}}$        & сход. \\
   			\hline 
					\hline 
  $\beta=3$                &0.2, 0.005         &                    &                &                  &                   \\
