...
\small
      ...
      \multirow{2  }{*}{ }        & \multirow{2  }{*}{$h$, $\tau$}  & \multirow{2  }{*}{грешки $\Vert E_i\Vert_{L_2}$}  &ред на& \multirow{2  }{*}{грешки $\Vert E_i\Vert_{L_\infty}$}  &ред на  \\
   			...
   			\hline 
					\hline 
  $\beta=3$                  &0.2, 0.1         &                    &                &                  &                   \\
   c=0.45                      &0.1, 0.05       & 0.989422   &                & 1.043649  &                   \\
     $O(h^2 + \tau^ 2)$ &0.05, 0.025   &0.344818    & 1.52       & 0.355517   &   1.55   \\
	   \hline
			\hline 
       $\beta=1$         & 0.4, 0.2       &                   &           &                 &   \\
                  c=0.9     & 0.2, 0.1       & 0.200424   &          &0.072726  &   \\
  $O(h^2+ \tau^2)$  & 0.1, 0.05     & 0.047899   & 2.06  &0.021451  & 1.76 \\
	   \hline
			\hline 
		\end{tabular}
