...
\subsection{Дискретните маса, енергия и форма - сравнение между метода на Тейлор и Консервативната схема}
...
\begin{itemize}
  ...
  \item K. Angelow, New Boundary Condition for the Two Dimensional Stationary Boussinesq Paradigm Equation, {\it International Journal of Applied Mathematics}, 32 (2017), 141-154
   \item K. Angelow, Comparison Between Two Numerical Methods for Solution of 2D BPE, {\it AIP Conference Proceedings}, 2522 (2022), 1
\end{itemize}
...
Масата за непрекъснатата задача \rf{problemVC}
\begin{equation}\label{intM}
D(u(x,y,t))=\int_{\RR^2} u(x,y,t)dx dy = const.
\end{equation}
...
\begin{frame}
\frametitle{Числени резултати}
\frametitle{Дискретна маса - сравнение между метода на Тейлор и Консервативната схема}
