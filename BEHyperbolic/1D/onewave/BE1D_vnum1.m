function [v,tt,E,II] = BE1D_vnum1(start_x,end_x,h,tau,sgm,t_end,beta1,beta2,alpha,estep,u_t0,dudt_t0)
...
Idh=(h^2*eye(7)-dh);
    ...
    while(t(k)<t_end)
        %picardi 2:
        vu = SIT_vsgm(sA,sB,sdh,a11,b11,vz,vmo,h,alpha,beta,sgm);
        
        %picardi:
        %vu = SIT_vs(sA,sB,sdh,a11,b11,vz,vmo,sx,alpha,beta);
